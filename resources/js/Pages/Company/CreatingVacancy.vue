...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Create vacancy</h2>
        </template>
                ...
                <div class="grid grid-cols-4 gap-2">
                    ...
                    <div class="col-span-3">
                        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                            <header>
                                <h2 class="text-lg font-medium text-gray-900">Create vacancy form</h2>
                            </header>

                            <form @submit.prevent="form.post(route('vacancies.create'))" class="mt-6 space-y-6">
                                <div>
